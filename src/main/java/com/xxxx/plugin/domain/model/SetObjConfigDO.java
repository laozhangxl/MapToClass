package com.xxxx.plugin.domain.model;
...
public class SetObjConfigDO {
    ...
    public SetObjConfigDO(String clazzParamName, List<String> paramList, Map<String, String> paramMtdMap, Map<String, String> paramTypeMap) {
